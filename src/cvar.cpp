...
BOOL    c_render__skybox_night                   = false;
BOOL    c_render__tboy                           = true;
BOOL    c_video__fps_info                        = false;
S32     c_video__fps_max                         = 60;
S32     c_video__render_resolution_height        = 1080;
S32     c_video__render_resolution_width         = 1920;
BOOL    c_video__vsync                           = true;
S32     c_video__window_resolution_height        = 1080;
S32     c_video__window_resolution_width         = 1920;
