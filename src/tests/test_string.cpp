...
void static test_string_create_empty() {
    String *s = string_create_empty(MEMORY_TYPE_TARENA);
    TEST_ASSERT_EQUAL_INT(0, s->length);
    TEST_ASSERT_EQUAL_INT(1, s->capacity);
    TEST_ASSERT_EQUAL_INT(MEMORY_TYPE_TARENA, s->memory_type);
    TEST_ASSERT_EQUAL_STRING("", s->c);
}

void static test_string_create_with_capacity() {
    String *s = string_create_with_capacity(MEMORY_TYPE_TARENA, 100);
    TEST_ASSERT_EQUAL_INT(0, s->length);
...
void static test_string_copy() {
    String *s = string_create(MEMORY_TYPE_TARENA, "Hello, world!");
...
void static test_string_copy_mt() {
    String *s = string_create(MEMORY_TYPE_TARENA, "Hello, world!");
    String *copy_s = string_copy_mt(MEMORY_TYPE_DARENA, s);
    TEST_ASSERT_NOT_NULL(copy_s);
    TEST_ASSERT_EQUAL_INT(s->length, copy_s->length);
    TEST_ASSERT_EQUAL_INT(s->capacity, copy_s->capacity);
    TEST_ASSERT_EQUAL_INT(MEMORY_TYPE_DARENA, copy_s->memory_type);
    TEST_ASSERT_EQUAL_STRING(s->c, copy_s->c);
}

void static test_string_repeat() {
    String *s = string_repeat(MEMORY_TYPE_TARENA, "Hello, world!", 3);
...
void static test_string_empty() {
    ...
    s = string_create_empty(MEMORY_TYPE_TARENA);
    TEST_ASSERT_EQUAL_INT(0, s->length);
    TEST_ASSERT_EQUAL_INT(1, s->capacity);
    TEST_ASSERT_EQUAL_INT(MEMORY_TYPE_TARENA, s->memory_type);
    TEST_ASSERT_EQUAL_STRING("", s->c);
...
void static test_string_starts_with() {
    ...
    TEST_ASSERT_EQUAL_INT(MEMORY_TYPE_TARENA, prefix->memory_type);
...
void static test_string_ends_with() {
    ...
    TEST_ASSERT_EQUAL_INT(MEMORY_TYPE_TARENA, suffix->memory_type);
...
void static test_string_contains() {
    ...
    TEST_ASSERT_EQUAL_INT(MEMORY_TYPE_TARENA, str->memory_type);
...
void static test_string_remove_ouc_codes() {
    String *s = string_create(MEMORY_TYPE_TARENA, "\\ouc{XXX}Hello, \\ouc{YYY}world! \\ouc{ZZZ}How are you?\\ouc{000} Goodbye!");
...
void static test_string_remove_start_to_end() {
    String *s = string_create(MEMORY_TYPE_TARENA, "ABC({123})DEF({456})GHI");
    string_remove_start_to_end(s, "({", "})");
    C8 const *expected = "ABCDEFGHI";
    TEST_ASSERT_NOT_NULL(s);
    TEST_ASSERT_EQUAL_STRING(expected, s->c);
    String *s2 = string_create(MEMORY_TYPE_TARENA, "ABC({123})DEF({456})GHI({789})");
...
void static test_string_remove_shell_escape_sequences() {
    String *s = string_create(MEMORY_TYPE_TARENA, "\033[31mHello, \033[34mworld! \033[32mHow are you?\033[31m Goodbye!");
...
void static test_string_replace_linebreaks() {
    ...
    String *s6 = string_create(MEMORY_TYPE_TARENA, "Hello\nWorld");
    string_replace_linebreaks(s6, "<br>");
    TEST_ASSERT_EQUAL_STRING("Hello<br>World", s6->c);
}

void static test_string_to_lower() {
    String *s = string_create(MEMORY_TYPE_TARENA, "Hello, WORLD! How ARE you 123?");
    string_to_lower(s);
...
void static test_string_to_capital() {
    String *s1 = string_create(MEMORY_TYPE_TARENA, "hello world how are you");
    string_to_capital(s1);
    TEST_ASSERT_EQUAL_STRING("Hello World How Are You", s1->c);

    String *s2 = string_create(MEMORY_TYPE_TARENA, "HELLO WORLD HOW ARE YOU");
    string_to_capital(s2);
    TEST_ASSERT_EQUAL_STRING("Hello World How Are You", s2->c);

    String *s3 = string_create(MEMORY_TYPE_TARENA, "hElLo WoRlD hOw ArE yOu");
    string_to_capital(s3);
    TEST_ASSERT_EQUAL_STRING("Hello World How Are You", s3->c);
}

void static test_string_truncate() {
    String *s1 = string_create(MEMORY_TYPE_TARENA, "Hello, world!");
    string_truncate(s1, 5, "...");
    TEST_ASSERT_EQUAL_STRING("He...", s1->c);
    String *s2 = string_create(MEMORY_TYPE_TARENA, "Hello, world!");
    string_truncate(s2, 10, "...");
    TEST_ASSERT_EQUAL_STRING("Hello, ...", s2->c);
    String *s3 = string_create(MEMORY_TYPE_TARENA, "Hello, world!");
