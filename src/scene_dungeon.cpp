...
SKIP_OTHER_INPUT:
    ...
    if (particle_timer >= spawn_interval) {
        ...
        particles3d_queue_fire(torch_left_pos, 0.3F, YELLOW, RED, 0.3F, 1);
        particles3d_queue_smoke(torch_left_pos, 0.2F, ORANGE, RED, 0.25F, 1);

        particles3d_queue_fire(torch_right_pos, 0.3F, YELLOW, RED, 0.3F, 1);
        particles3d_queue_smoke(torch_right_pos, 0.2F, ORANGE, RED, 0.25F, 1);
    }
}
